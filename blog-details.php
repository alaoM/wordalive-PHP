...
list($topic, $description, $image_path) = $database->fetchWrittenSermonById();
                                ...
                                <div class="col-md-6">
                                    <article class="sigma_post">
                                        ...
                                        <div class="sigma_post-body">
                                            ...
                                            <h5> <a href="series.php#<?=$row['category']?>"><?=$row['topic']?></href=> </h5>
                                            <?php echo substr($row['description'], 0, 50)?>...<a href="series.php#<?=$row['category']?>">Read More</a>
                                        </div>
                                    </article>
                                </div>
                                <?php
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-widget widget-about-author">
                            ...
                            <div class="widget-about-author-inner">
                                <img src="assets/img/about-me/dvse234-small.jpg" alt="author">
                                <h5>Adesoye Akeem Owolabi</h5>
                                <p>"I am passionate about youth ministry so you can also join me too"</p>
                                <ul class="sigma_sm">
                                    <li>
                                        <a href="https://www.facebook.com/The-Word-Lives-International-Ministry-100719995846507/"
                                    ...
                                    <li>
                                        <a href="https://youtube.com/channel/UCiVKWP0uIHbjVgVONm0Z0-g" target="_blank"
