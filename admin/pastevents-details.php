                                ...
                                <table id="data-table" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                        ...
                                        <tr>                                        
                                            ...
                                            <td id="portfolio"><?=$row['portfolio']?></td>                                            
                                            <td>
                                                <button id="edit" data-id1="<?=$row['id']?>" data-id2="portfolio" class="btn btn-primary waves-effect waves-light edit" data-toggle="modal" data-target="#largeModal"> <i class="zmdi zmdi-eye"></i> Preview </button>
                                                <button id="delete" data-id3="<?=$row['id']?>" data-id4="portfolio" class="btn btn-danger waves-effect waves-light delete"> <i class="zmdi zmdi-delete"></i> Delete </button>
