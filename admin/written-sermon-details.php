        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Bible Study DataTables</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> Word Alive</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Bible Study</a></li>
                                ...
                                <table id="data-table" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                        ...
                                        <tr>                                        
                                            ...
                                            <td id="sn"><?=$sn++?></td>
                                            <td id="title"><?=$row['topic']?></td>
                                            <td id="subtitle"><?=$row['description']?></td>
                                            <td>
                                                <button id="edit" data-id1="<?=$row['id']?>" data-id2="writtensermon" class="btn btn-primary waves-effect waves-light edit" data-toggle="modal" data-target="#largeModal"> <i class="zmdi zmdi-eye"></i> Preview </button>
                                                <button id="delete" data-id3="<?=$row['id']?>" data-id4="writtensermon" class="btn btn-danger waves-effect waves-light delete"> <i class="zmdi zmdi-delete"></i> Delete </button>
