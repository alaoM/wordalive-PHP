                            ...
                            <div class="table-responsive">
                                <table id="data-table" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                        ...
                                        <tr>     
                                            <td id="sn"><?=$sn++?></td>
                                            <td id="title"><?=substr($row['title'], 0, 50)?></td>
                                            <td id="portfolio"><?=$row['location']?></td>   
                                            <td id="date"><?=$row['date']?></td>   
                                            <td>
                                                <button id="edit" data-id1="<?=$row['id']?>" data-id2="events" class="btn btn-primary waves-effect waves-light edit" data-toggle="modal" data-target="#largeModal"> <i class="zmdi zmdi-eye"></i> Preview </button>
                                                <button id="delete" data-id3="<?=$row['id']?>" data-id4="events" class="btn btn-danger waves-effect waves-light delete"> <i class="zmdi zmdi-delete"></i> Delete </button>
                                            </td>                                         
                                        </tr>
                                        <?php endforeach;  ?>
                ...
                <div class="blogitem mb-5">
                    ...
                    <div class="blogitem-header">
                                    <div class="blogitem-meta">
                                        <span><i class="zmdi zmdi-my-location"></i>By <a id="preacher" href="javascript:void(0);"></a></span>
                                    </div>
                                </div>                             
