...
<?php include_once('assets/includes/nav.html')?>
                ...
                <form action="./assets/includes/uploadForm/forms.php" id="form_validation" class="sermon_submit validate" method="POST" enctype="multipart/form-data">
                    <div class="row clearfix">
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    <div class="form-group form-float">
                                        ...
                                        <input type="text" name="sermon_title" class="form-control" placeholder="Sermon Title"
                                            required />
                                    </div>
                                    <div class="form-group form-float">
                                        <label for="preacher"> Preacher</label>
                                        <input type="text" name="preacher" class="form-control" placeholder="Preacher"
                                            required />
                                    </div>
                                    <div class="form-group form-float">
                                        <label for="date"> Date Delivered</label>
                                        <input type="date" name="sermon_date" class="form-control"
                                            placeholder="Date Delivered" required />
                                    </div>
                                    <div class="form-group form-float">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h2><strong>Background Image for sermon</strong> </h2>
                                </div>
                                <div class="body">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h2><strong>Sermon Video / Audio</strong></h2>
                                </div>
                                <div class="body">
                                    <p>Upload any of the following formats: mp4, mp3, mov, wmv, avi, aac, ogg mkv</p>
                                    <input type="file" name="uploadVideo" class="dropify" data-allowed-file-extensions="mp4 mp3 mov wmv avi aac ogg mkv" data-max-file-size="200M">
                                </div>
                            </div>
                        </div>
                        <button
    ...
    <script src="assets/bundles/mainscripts.js"></script>
